...
public class EmployeesSteps {
    ...
    public void verifyResponseSize(int size) throws InterruptedException {
    ...
    public void verifyEmployeeResponseData(DataTable employeeInfo) throws InterruptedException {
        List<String> data = employeeInfo.transpose().asList(String.class);
    ...
    public void verifyDelete(String id) throws InterruptedException {
    ...
    public void verifyEmployee(Integer id) throws InterruptedException {
